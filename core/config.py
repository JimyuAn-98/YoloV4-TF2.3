...
__C.YOLO.CLASSES              = "./data/classes/yg_combined.names"
...
__C.TRAIN.ANNOT_PATH          = "./data/dataset/yg_combined_train.txt"
...
__C.TEST.ANNOT_PATH           = "./data/dataset/yg_combined_test.txt"
